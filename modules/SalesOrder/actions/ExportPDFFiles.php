...
class SalesOrder_ExportPDFFiles_Action extends Vtiger_Action_Controller {
    ...
    public function process(Vtiger_Request $request) {
        ...
        error_log("=== [$timestamp] SalesOrder ExportPDFFiles Action Called - NEW VERSION ===");
    ...
    private function generatePDFFiles($recordIds, $moduleName, $createOnly = false) {
        ...
        $zipFileName = "Danh Sách Giấy Báo Nhập Học " . $currentDate . '.zip';
        ...
        foreach($recordIds as $index => $recordId) {
            ...
            try {
                ...
                // Save individual PDF file to cache/letters/pdf directory for debugging
