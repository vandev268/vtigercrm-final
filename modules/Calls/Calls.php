...
class Calls extends Vtiger_CRMEntity {
	...
	var $popup_fields = Array ('callby');

	// For Alphabetical search
	var $def_basicsearch_col = 'callby';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'callby';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('callby','assigned_user_id');

	var $default_order_by = 'callby';
