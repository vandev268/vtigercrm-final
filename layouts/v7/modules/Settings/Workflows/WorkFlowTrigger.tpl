...
{strip}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6 controls">
            ...
            <span><input type="radio" name="workflow_trigger" value="5" {if $EXECUTION_CONDITION eq '5'} checked="" {/if}> <span id="workflowTriggerDelete">{vtranslate($SINGLE_SELECTED_MODULE, $SELECTED_MODULE)} {vtranslate('LBL_DELETION', $QUALIFIED_MODULE)}</span></span><br>
