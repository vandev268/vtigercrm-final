...
<head>
	...
	<link rel="stylesheet"  type="text/css" href="layouts/v7/modules/CTChatLog/css/allChatsRTL.css">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<div class="dropdown">
						<div id="quickAccessDiv" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
							<a href="#"><p><img src="layouts/v7/modules/CTChatLog/image/listing_green.png" style="width: 20px;">{vtranslate('LBL_QUICK_ACCESS', $MODULENAME)}</p></a>
						</div>
						<ul class="dropdown-menu facebookMenus facebookb" role="menu" aria-labelledby="dropdownMenu1" style="width:370px;">
							<li>
								<a href="index.php?module=Workflows&parent=Settings&view=List">
									<p>{vtranslate('LBL_AUTOMATEWORKFLOW', $MODULENAME)} <img src="layouts/v7/modules/CTChatLog/image/fbWorkflow.png" title="{vtranslate('LBL_AUTOMATEWORKFLOW', $MODULENAME)}"/></p>
								</a>
							</li>
							<li>
								<a href="index.php?module=CTChatLogDetails&view=List&app=TOOLS">
									<p>{vtranslate('LBL_FACEBOOK_MESSAGES_LOG', $MODULENAME)} <img src="layouts/v7/modules/CTChatLog/image/wa_messages.png" title="{vtranslate('LBL_FACEBOOK_MESSAGES_LOG', $MODULENAME)}"> 
									</p>
								</a>
							</li>
							<li>
								<a href="index.php?parent=Settings&module=CTFacebookMessengerIntegration&view=CTGeneralConfiguration">
									<p>{vtranslate('LBL_SETUP_FB_CONFIGURATION', $MODULENAME)} <img src="layouts/v7/modules/CTChatLog/image/wa_setup.png" title="Setup "> 
									</p>
								</a>
							</li>
							<li>
								<a href="index.php?module=CTChatLog&view=DashBoard&mode=moduleDashBoard&analytics=1">
									<p>{vtranslate('LBL_FB_ANALYTICS', $MODULENAME)} <img src="layouts/v7/modules/CTChatLog/image/dashboardBlue.png" title="{vtranslate('LBL_FB_ANALYTICS', $MODULENAME)}"/></p>
								</a>
							</li>
							<li>
								<a id="logoutFacebookQuickAccess">
									<p>{vtranslate('LBL_FACEBOOK_LOGOUT', $MODULENAME)} <img src="layouts/v7/modules/CTChatLog/image/logout.png" title="Logout Facebook"> 
									</p>
								</a>
							</li>
							...
							<li>
								<a href="https://kb.crmtiger.com/article-categories/facebook-messenger-integration-for-vtiger/" target="_blank">
									<p>{vtranslate('LBL_FACEBOOK_HELP', $MODULENAME)} <img src="layouts/v7/modules/CTChatLog/image/fbHelp.png" title="{vtranslate('LBL_FACEBOOK_HELP', $MODULENAME)}"></p>
								</a>
							</li>
									...
									<div class="convHead">
										...
										<ul class="nav" id="addProfile">
											...
											<li class="recordAssign">
												<img src="layouts/v7/modules/CTChatLog/image/assignto.png" title="{vtranslate('Assigned To', $MODULENAME)}"/>
											</li>
											<li class="editModuleRecord">
												<img class="editIcon" src="layouts/v7/modules/CTChatLog/image/edit.png" title="{vtranslate('LBL_EDIT_RECORD', $MODULENAME)}"/>
											</li>
											<li class="importantMessages hide"><input type="hidden" name="messagesImportant" id="messagesImportant" value=""><img src="layouts/v7/modules/CTChatLog/image/favorites.png" title="{vtranslate('LBL_IMPORTTANTMESSAGE', $MODULENAME)}"/></li>
										 	<li class="nav-item dropdown">
										 		<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">
										 			<img src="layouts/v7/modules/CTChatLog/image/plus.png" class="plusIcon" title="{vtranslate('LBL_STORESENDER', $MODULENAME)}">
										 		</a>
									...
									<div>
										<div>
											<div class="ipt-div text-wrapper">
												<div class="ipt-msg-div searchForm conversation-compose text-wrapper facebookb" data-emojiarea data-type="unicode" data-global-picker="false">
											...
											<div class="icons-wrapper">
												<div class="ipt-div-num facebookb">
													<span id="sendfacebookmsg" class="send msg_send_btn" style="cursor: pointer;">
