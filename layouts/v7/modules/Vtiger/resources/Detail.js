...
Vtiger.Class(
  "Vtiger_Detail_Js",
  {
    ...
    deleteRelatedActivity: function (e) {
      ...
      if (recurringEnabled) {
        app.helper.showConfirmationForRepeatEvents().then(
          function (params) {
    ...
    showUpdates: function (element) {
      ...
      params.url =
        "index.php?view=Detail&module=" +
        app.getModuleName() +
        "&mode=showRecentActivities&record=" +
        recordId;
      ...
      form.on("click", "button[name='saveButton']", function (e) {
        ...
        var params = {
          ...
          submitHandler: function (form) {
            ...
            app.request.post({ data: reqParams }).then(function (error, data) {
              if (error === null) {
                jQuery(".vt-notification").remove();
                app.helper.hideModal();
                app.helper.showSuccessNotification({
                  message: app.vtranslate(
                    "JS_RECORDS_TRANSFERRED_SUCCESSFULLY"
                  ),
                });
              } else {
  ...
  },
  {
            ...
            app.request.post(postParams).then(function (err, data) {
              ...
              if (err === null) {
                ...
                var relatedController =
                  thisInstance.getRelatedController(relatedModuleName);
    ...
    sendSMSAction: function (detailActionUrl, callBackFunction) {
      ...
      app.request
        .post({ url: detailActionUrl, data: postData, dataType: "html" })
    ...
    registerSendSmsSubmitEvent: function () {
      ...
      jQuery("body").on("submit", "#massSave", function (e) {
        ...
        if (smsTextLength > 160) {
          app.helper.showErrorNotification({
            message: app.vtranslate("LBL_SMS_MAX_CHARACTERS_ALLOWED"),
          });
          return false;
        }
    ...
    SendSmsSave: function (form) {
      ...
      app.request.post({ data: formData }).then(function (err, data) {
        ...
        if (err) {
          app.helper.showErrorNotification({
            message: app.vtranslate("JS_PHONEFORMAT_ERROR"),
          });
          return;
        }
        ...
        if (status == "Failed") {
          var errorMsg =
            ...
            "<br>" +
            app.vtranslate("JS_PHONEFORMAT_ERROR");
          app.helper.showErrorNotification({
            title: status,
            message: errorMsg,
          });
    ...
    registerEventForRelatedTabClick: function () {
      var self = this;
      var detailViewContainer = this.getDetailViewContainer();
      jQuery(".related-tabs", detailViewContainer).on(
        "click",
        "li.tab-item a",
        function (e, urlAttributes) {
          e.preventDefault();
        }
      );
      jQuery(".related-tabs", detailViewContainer).on(
    ...
    registerRollupCommentsSwitchEvent: function () {
      ...
      if (
        jQuery("#rollupcomments").length > 0 &&
        commentsRelatedContainer.length
      ) {
        app.helper.hideProgress();
          ...
          if (relatedModuleName == "Calendar" && row.data("recurringEnabled")) {
            app.helper.showConfirmationForRepeatEvents().then(
              function (customParams) {
                relatedController
                  .deleteRelation([relatedRecordid], customParams)
            ...
            app.helper.showConfirmationBox({ message: message }).then(
              function (e) {
                ...
                relatedController
                  .deleteRelation([relatedRecordid])
                  .then(function (response) {
                    relatedController.loadRelatedList().then(function () {
                      relatedController.triggerRelationAdditionalActions();
                    });
    ...
    registerEventForEmailsRelatedRecord: function () {
      ...
      detailContentsHolder.on(
        "click",
        '[name="emailsRelatedRecord"], [name="emailsDetailView"]',
        function (e) {
          e.stopPropagation();
          var element = jQuery(e.currentTarget);
              ...
              app.helper.showModal(data, {
                cb: function () {
                  ...
                  jQuery("#emailPreviewIframe").height(
                    jQuery(".email-body-preview").height()
                  );
                  jQuery("#emailPreviewIframe")
                    .contents()
                    .find("html")
      ...
      detailContentsHolder.on("click", '[name="emailsEditView"]', function (e) {
        ...
        app.helper.checkServerConfig(module).then(function (data) {
          if (data == true) {
            ...
            app.helper.showErrorMessage(
              app.vtranslate("JS_EMAIL_SERVER_CONFIGURATION")
            );
          }
        });
      });
    ...
    remove: function (deleteRecordActionUrl) {
      ...
      app.helper
        ...
        .then(function (data) {
          var params = app.convertUrlToDataParams(
            deleteRecordActionUrl + "&ajaxDelete=true"
          );
          app.request.post({ data: params }).then(function (err, data) {
            if (err === null) {
    ...
    registerRelatedListSearch: function () {
      ...
      detailViewContainer.on(
        "click",
        '[data-trigger="relatedListSearch"]',
        function (e) {
          var params = { page: "1" };
    ...
    registerRelatedListSort: function () {
      ...
      detailViewContainer.on(
        "click",
        ".listViewContentHeaderValues,.relatedListHeaderValues",
        function (e) {
          var fieldName = jQuery(e.currentTarget).attr("data-fieldname");
          var sortOrderVal = jQuery(e.currentTarget).attr(
    ...
    getRelatedController: function (relatedModuleName) {
      ...
      if (typeof window[relatedListClass] != "undefined") {
        return Vtiger_RelatedList_Js.getInstance(
          recordId,
          moduleName,
          selectedTabElement,
          relatedModuleName
    ...
    saveFieldValues: function (fieldDetailList) {
      ...
      app.request.post({ data: data }).then(function (err, reponseData) {
        if (err === null) {
          app.helper.showSuccessNotification({
      ...
      editElement.find(".inputElement:not(textarea)").on("keyup", function (e) {
        ...
        if (!textArea.length) {
          (e.keyCode || e.which) === 13 &&
            editElement.find(".inlineAjaxSave").trigger("click");
        }
      });
    },
    ...
    ajaxEditHandling: function (currentTdElement) {
      ...
      if (jQuery(".editElement", editElement).length === 0) {
        ...
        var actionButtons =
          '<span class="pointerCursorOnHover input-group-addon input-group-addon-save inlineAjaxSave"><i class="fa fa-check"></i></span>';
        actionButtons +=
          '<span class="pointerCursorOnHover input-group-addon input-group-addon-cancel inlineAjaxCancel"><i class="fa fa-close"></i></span>';
      ...
      if (
        ...
        var sourcePicklistFieldName =
          thisInstance.getDependentSourcePicklistName(fieldName);
    ...
    getDependentSourcePicklistName: function (fieldName) {
      ...
      jQuery.each(
        ...
        function (sourcePicklistName, configuredDependencyObject) {
      ...
      contentHolder.on("click", ".inlineAjaxSave", function (e) {
        ...
        if (previousValue == ajaxEditNewValue) {
          ...
          var params = {
            ...
            submitHandler: function (form) {
              var preAjaxSaveEvent = jQuery.Event(
                Vtiger_Detail_Js.PreAjaxSaveEvent
              );
              app.event.trigger(preAjaxSaveEvent, {
                form: jQuery(form),
                triggeredFieldInfo: fieldNameValueMap,
              });
              if (preAjaxSaveEvent.isDefaultPrevented()) {
                return false;
              }

              jQuery(currentTdElement)
              ...
              thisInstance
                ...
                .then(function (err, response) {
                  ...
                  if (
                    fieldBasicData.data("type") == "picklist" &&
                    app.getModuleName() != "Users"
                  ) {
                    var color =
                      postSaveRecordDetails[fieldName].colormap[
                        postSaveRecordDetails[fieldName].value
                      ];
                    if (color) {
                      var contrast = app.helper.getColorContrast(color);
                      var textColor = contrast === "dark" ? "white" : "black";
                      var picklistHtml =
                        '<span class="picklist-color" style="background-color: ' +
                        color +
                        "; color: " +
                        textColor +
                        ';">' +
                    ...
                    fieldBasicData.data("type") == "multipicklist" &&
                    app.getModuleName() != "Users"
                  ) {
                    var picklistHtml = "";
                    var rawPicklistValues =
                      postSaveRecordDetails[fieldName].value;
                    ...
                    fieldBasicData.data("type") == "currency" &&
                    app.getModuleName() != "Users"
                  ) {
                    detailViewValue
                      .find(".currencyValue")
                    ...
                    contentHolder
                      .closest(".detailViewContainer")
                      .find(".detailview-header-block")
                      .find("." + fieldName)
                      .html(postSaveRecordDetails[fieldName].display_value);
                  } else {
                  ...
                  var postAjaxSaveEvent = jQuery.Event(
                    Vtiger_Detail_Js.PostAjaxSaveEvent
                  );
                  app.event.trigger(
                    postAjaxSaveEvent,
                    fieldBasicData,
    ...
    handlePickListDependencyMap: function (sourcePicklistName) {
      ...
      var selectedValue = container
        .find("[data-name=" + sourcePicklistName + "]")
        .data("value");
      ...
      jQuery.each(
        ...
        function (targetPickListName, targetPickListValues) {
          ...
          targetPickListSelectedValue = targetOptions
            .filter("[selected]")
            .val();
          ...
          if (
            ...
            jQuery("[data-name=" + sourcePicklistName + "]").data("value") == ""
          ) {
            return false;
          }
          targetPickList
    ...
    registerBlockStatusCheckOnLoad: function () {
      ...
      blocks.each(function (index, block) {
        ...
        var headerAnimationElement = currentBlock
          .find(".blockToggle")
          .not(".hide");
    ...
    registerEventForActivityWidget: function () {
      ...
      jQuery(".createActivity").on("click", function (e) {
        ...
        if (quickCreateNode.length <= 0) {
          app.helper.showErrorMessage(
            app.vtranslate("JS_NO_CREATE_OR_NOT_QUICK_CREATE_ENABLED")
          );
        }
        ...
        app.event.on("post.QuickCreateForm.show", function (event, form) {
          ...
          jQuery(
            '<input type="hidden" name="sourceRecord" value="' +
              recordId +
              '" >'
          ).appendTo(form);
          jQuery(
    ...
    registerSummaryViewContainerEvents: function (summaryViewContainer) {
      ...
      jQuery(".createRecord").on("click", function (e) {
        var currentElement = jQuery(e.currentTarget);
        var summaryWidgetContainer = currentElement.closest(
          ".summaryWidgetContainer"
        );
        var widgetHeaderContainer =
          summaryWidgetContainer.find(".widget_header");
        var referenceModuleName = widgetHeaderContainer
        ...
        app.event.on("post.QuickCreateForm.save", function (event, data) {
          ...
          self
            .addRelationBetweenRecords(referenceModuleName, idList)
            .then(function (data) {
              self.loadWidget(
                summaryWidgetContainer.find('[class^="widgetContainer_"]')
              );
            });
        });
      ...
      app.request.post(params).then(
        function (err, data) {
          ...
          app.helper.showVerticalScroll(
            contentContainer.find(".twitterContainer"),
            {
    ...
    saveComment: function (e) {
      ...
      if (commentMode == "edit") {
        var editCommentReason = closestCommentBlock
          .find('[name="reasonToEdit"]')
          .val();
      ...
      var commentInfoHeader = closestCommentBlock
        .closest(".commentDetails")
        .find(".commentInfoHeader");
      ...
      if (commentMode == "edit") {
        ...
        (postData["filename"] = Vtiger_Index_Js.files), (incrementCount = true);
      }
    ...
    getEditCommentBlock: function () {
      var detailContentsHolder = this.getContentHolder();
      var clonedCommentBlock = jQuery(
        ".basicEditCommentBlock",
        detailContentsHolder
      )
        .clone(true, true)
        .removeClass("basicEditCommentBlock hide")
        .addClass("addCommentBlock");
      clonedCommentBlock
    ...
    getCommentBlock: function () {
      var detailContentsHolder = this.getContentHolder();
      var clonedCommentBlock = jQuery(
        ".basicAddCommentBlock",
        detailContentsHolder
      )
        .clone(true, true)
        .removeClass("basicAddCommentBlock hide")
        .addClass("addCommentBlock");
      clonedCommentBlock
        .find(".commentcontenthidden")
        .removeClass("commentcontenthidden")
    ...
    toggleCommentContent: function (e) {
      var currentTarget = jQuery(e.currentTarget);
      var commentContentBlock = currentTarget.closest(
        ".commentInfoContentBlock"
      );
      var commentContentInfo = commentContentBlock.find(".commentInfoContent");
      var toggleElement = jQuery(
        '<div><a class="pull-right toggleComment" style="color: blue;"><small></small></a><div>'
      );
      var fullComment = vtUtils.linkifyStr(
        commentContentInfo.data("fullcomment")
      );
      ...
      if (currentTarget.hasClass("showMore")) {
        ...
        commentContentInfo.html(
          vtUtils.htmlSubstring(fullComment, maxLength) +
            "..." +
            toggleElement.clone().html()
        );
      }
    },
    ...
    toggleRollupComments: function (e) {
      ...
      if (viewtype == "relatedlist") {
        url =
          "index.php?module=Vtiger&view=ModCommentsDetailAjax&parent=" +
          moduleName +
          "&parentId=" +
          recordId +
          "&rollupid=" +
        ...
        app.request.get(params).then(function (err, data) {
          ...
          jQuery('div.related-tabs li[data-label-key="ModComments"]').trigger(
            "click"
          );
        });
      } else {
        url =
          "index.php?module=" +
          moduleName +
          "&relatedModule=ModComments&view=Detail&record=" +
          recordId +
        ...
        app.request.get(params).then(function (err, data) {
          ...
          vtUtils.enableTooltips();
          self.registerRollupCommentsSwitchEvent();
          jQuery("#rollupcomments").bootstrapSwitch(
            "state",
            rollupstatus,
            true
          );
          ...
          var registerShowAllTagEvents = function (modalContainer) {
            ...
            form.on("submit", function (e) {
              ...
              self.saveTag(saveParams).then(function (data) {
                jQuery(".showAllTagContainer")
                  .find(".currentTag")
                  .html(modalContainerClone.find(".currentTag").html());
                jQuery(".showAllTagContainer")
                  .find(".currentTagMenu")
                  .html(modalContainerClone.find(".currentTagMenu").html());
              });
              return false;
            });
          };
    ...
    addTagsToSummaryTag: function (tagsList) {
      ...
      var numOfTagsToAppend =
        numOfTagsToShow - parseInt(summaryTagList.find(".tag").length);
    ...
    removeDeletedTagsFromSummaryTag: function (deletedTags) {
      ...
      for (var index in deletedTags) {
        var tag = summaryTagContainer.find(
          '.tag[data-id="' + deletedTags[index] + '"]'
        );
        if (tag.length > 0) {
          ...
          var nextTag = currentTagHolder
            .find('[data-id="' + summaryLastTag.data("id") + '"]')
            .next();
    ...
    registerTagEvents: function () {
      ...
      tagContainer
        .find("#addTagContainer .dropdown-menu")
        .on("click", function (e) {
          e.stopPropagation();
        });
      ...
      jQuery("#saveTag").on("click", function (e) {
        ...
        var selectedTagElement = existingTagContainer
          .find(".tagSelector")
          .filter(":checked")
          .closest("li.tag-item");
        ...
        var visibilityCheckBox = createTagContainer.find(
        ...
        self
          .saveTag({ tagsList: tagsList, newTagType: visibility })
          .then(function (data) {
      ...
      app.event.on(
        "post.MassTag.save",
        function (e, modalContainerClone, data) {
      ...
      tagContainer.find(".moreTags").on("click", function (e) {
        ...
        app.event.trigger("Request.AllTag.show", tagContainer, {
      ...
      jQuery("#addTagTriggerer").on("click", function (e) {
        app.event.trigger("Request.MassTag.show", tagContainer, {
          record: self.getRecordId(),
        });
      });
    },
        ...
        if (selection.length == 0) {
          ...
          if (typeof recordUrl != "undefined") {
            ...
            app.request.get({ data: params }).then(function (err, response) {
              ...
              app.helper
                .loadPageContentOverlay(response, overlayParams)
                .then(function (container) {
                  var detailjs = Vtiger_Detail_Js.getInstanceByModuleName(
                    params.module
                  );
                  ...
                  detailjs.setDetailViewContainer(
                    container.find(".overlayDetail")
                  );
                  detailjs.registerOverlayEditEvent();
                  detailjs.registerBasicEvents();
                  detailjs.registerClickEvent();
                  detailjs.registerHeaderAjaxEditEvents(
                    container.find(".overlayDetailHeader")
                  );
                  detailjs.registerEventToReloadRelatedListOnCloseOverlay(
                    parentRecordId
                  );
                  app.event.trigger(
                    "post.overlay.load",
        ...
        app.helper
          ...
          .then(function (container) {
            var height =
              ...
              jQuery(".app-fixed-navbar").height() -
              jQuery(".overlayFooter").height() -
              80;
    ...
    recordImageRandomColors: function () {
      ...
      if (color === "rgba(0, 0, 0, 0)") {
        jQuery(".recordImage").css(
          "background-color",
          app.helper.getRandomColor()
        );
      }
    },
    ...
    registerQtipevent: function (tabItem) {
      if (typeof tabItem == "undefined") {
        ...
        app.helper.showVerticalScroll(scrollContent, {
    ...
    registerEvents: function () {
      ...
      detailContentsHolder.on("click", ".viewThread", function (e) {
        ...
        self.getChildComments(commentId).then(function (data) {
          jQuery(data).appendTo(
            jQuery(e.currentTarget).closest(".commentDetails")
          );
          commentActionsBlock.find(".hideThreadBlock").show();
          currentTargetParent.hide();
        });
      ...
      detailContentsHolder.on("click", ".detailViewThread", function (e) {
        var recentCommentsTab = self.getTabByLabel(
          self.detailViewRecentCommentsTabLabel
        );
        var commentId = jQuery(e.currentTarget)
          .closest(".singleComment")
          .find(".commentInfoHeader")
          .data("commentid");
      ...
      app.event.on("post.mail.sent", function (event, data) {
        ...
        if (success.length > 0) {
          ...
          if (relatedLoad == 1) {
            ...
            window.app
              .controller()
              .loadRelatedListRecords({ page: pageNumber });
          } else {
            app.helper.showModal(data);
          }
        }
      ...
      detailContentsHolder.on("click", ".moreRecentUpdates", function () {
        ...
        var url =
          ...
          "&view=Detail&record=" +
          recordId +
          "&mode=showRecentActivities&page=" +
          nextPage +
          "&limit=5&tab_label=LBL_UPDATES";
      ...
      detailContentsHolder.on("click", ".detailViewSaveComment", function (e) {
        ...
        if (!element.is(":disabled")) {
          ...
          dataObj.then(function () {
            var commentsContainer = detailContentsHolder.find(
              "[data-name='ModComments']"
            );
            ...
            if (mode == "add") {
              ...
              commentHtml.then(function (data) {
                ...
                if (jQuery(data).hasClass("privateComment")) {
                  html =
                    '<ul class="unstyled"><li class="commentDetails" style="background: #fff9ea;">' +
                    data +
                    "</li></ul>";
                } else {
                  html =
                    '<ul class="unstyled"><li class="commentDetails">' +
                    data +
                    "</li></ul>";
                }
                var commentBlock =
                ...
                var noCommentsMsgContainer = jQuery(
                ...
                if (commentBlock.length > 0) {
                  ...
                  if (childComments.length <= 0) {
                    var currentChildCommentsCount = commentInfoBlock
                      .find(".viewThreadBlock")
                      .data("childCommentsCount");
                    var newChildCommentCount = currentChildCommentsCount + 1;
                    commentInfoBlock
                      .find(".childCommentsCount")
                      .text(newChildCommentCount);
                    var parentCommentId = commentInfoBlock
                      .find(".commentInfoHeader")
                      .data("commentid");
                    self
                  ...
                  jQuery(html).prependTo(
                    closestAddCommentBlock
              ...
              var commentInfoContent = commentInfoBlock.find(
                ".commentInfoContent"
              );
              var commentEditStatus = commentInfoBlock.find(
                '[name="editStatus"]'
              );
      ...
      detailContentsHolder.on("click", ".editComment", function (e) {
        ...
        editCommentBlock
          .find('[name="reasonToEdit"]')
          .val(commentReason.text());
        editCommentBlock
          .find('[name="is_private"]')
          .val(commentInfoBlock.find('[name="is_private"]').val());
      ...
      detailContentsHolder.on("click", ".moreRecentActivities", function () {
        var recentActivitiesTab = self.getTabByLabel(
          self.detailViewRecentActivitiesTabLabel
        );
        recentActivitiesTab.trigger("click");
      });

      detailContentsHolder.on("click", ".moreRecentDocuments", function () {
        var recentDocumentsTab = self.getTabByLabel(
          self.detailViewRecentDocumentsLabel
        );
      ...
      detailContentsHolder
        .off(".toggleComment")
        .on("click", ".toggleComment", function (e) {
          self.toggleCommentContent(e);
        });

      app.event.on(
        "post.summarywidget.load",
        function (event, widgetContainer) {
          ...
          if (
            jQuery("#rollupcomments").length > 0 &&
            widgetContainer.data("name") == "ModComments"
          ) {
            widgetContainer
              .off("switchChange.bootstrapSwitch")
              .on(
      ...
      if (typeof jQuery.fn.sadropdown === "function") {
        jQuery(".widgetContainer_documents")
    ...
    registerPostAjaxSaveEvent: function () {
      ...
      app.event.on(
        Vtiger_Detail_Js.PostAjaxSaveEvent,
        function (e, fieldBasicData, postSaveRecordDetails, contentHolder) {
          if (typeof contentHolder == "undefined") {
            return;
          }
          ...
          if (fieldBasicData.length && isHeaderAjax) {
            ...
            var activeTabItem = jQuery(".related-tabs", detailViewContainer)
              .find("li.tab-item")
              .filter(".active");
            if (!activeTabItem.length) {
              activeTabItem = jQuery(".related-tabs", detailViewContainer).find(
                "li.tab-item:first"
              );
            }
