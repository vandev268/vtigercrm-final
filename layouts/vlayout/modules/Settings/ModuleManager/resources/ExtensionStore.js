 ...
 *************************************************************************************/
jQuery.Class(
  "Settings_ModuleManager_ExtensionStore_Js",
  {},
  {
    /**
    ...
    registerEventsForStep1: function (container) {
      ...
      jQuery(container).on("click", ".extensionDetails", function (e) {
        ...
        var moduleAction = extensionContainer
          .find('[name="moduleAction"]')
          .val();
        var extensionName = extensionContainer
          .find('[name="extensionName"]')
          .val();
        var params = {
          module: app.getModuleName(),
          parent: app.getParentModuleName(),
      ...
      jQuery(container).on("click", "#installLoader", function (e) {
        var extensionLoaderModal = jQuery(container)
          .find(".extensionLoader")
          .clone(true, true);
        extensionLoaderModal.removeClass("hide");

        var callBackFunction = function (data) {};
        app.showModalWindow(
          extensionLoaderModal,
          function (data) {
    ...
    registerEventsForImportModuleStep2: function (container) {
      ...
      app.showScrollBar(jQuery("div.scrollableTab"), {
        width: "100%",
        height: "400px",
      });
      this.registerRaty();
