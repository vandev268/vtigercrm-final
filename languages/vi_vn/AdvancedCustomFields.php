...
$languageStrings = array(
    ...
    'LBL_RTF_FIELD' => 'RTF Description field',
    'LBL_UPLOAD_FIELD' => 'Upload field',
    /* For License page - Begin */
        'MODULE_LBL' => 'Advanced Custom Fields',
        ...
        'LBL_INFO_BLOCK'=>'Info',
        'LBL_INFO_BLOCK_ON_SETTING_PAGE'=>'No configuration is needed. To add new advanced custom fields, please go to the Module Layouts & Fields, Create new field and you will see that there are new field types such as "Upload", "RTF", "Assigned To".<br /><br />NOTE: Please refer to the extension user guide for more details. User guide includes detailed explanation of how the extension works and how it can be configured.',
        'LBL_INFO_BLOCK_ON_SETTING_PAGE_V6'=>'No configuration is needed. To add new advanced custom fields, please go to the Fields and Layout Editor, Create new field and you will see that there are new field types such as "Upload", "RTF", "Assigned To".<br /><br />NOTE: Please refer to the extension user guide for more details. User guide includes detailed explanation of how the extension works and how it can be configured.',
);

$jsLanguageStrings = array(
    'LBL_RTFText_SAVED' => 'Advanced custom fields saved',
);