...
$languageStrings = array(
    'LBL_SIMPLEEXTENSION_HELLO_WORLD_MSG' => 'Hello World!',
    'LBL_SIMPLEEXTENSION_HELLO_WORLD_DESC' => 'This string was translated from the languages folder',
    'Macros' => 'Macros',
    ...
    'LBL_INFO_BLOCK'=>'Info',
    'LBL_INFO_BLOCK_ON_SETTING_PAGE'=>'Macros has to be creating using workflows. Please go to Automation > Workflows, create new/edit existing workflow and you see under "Workflow Trigger" there will be new option "Macro"<br /><br />NOTE: Please refer to the extension user guide for more details. User guide includes detailed explanation of how the extension.',
    'LBL_INFO_BLOCK_ON_SETTING_PAGE_V6'=>'Macros has to be creating using workflows. Please go to Other Settings > Workflows, create new/edit existing workflow and you see under "Specify when to execute this Workflow" there will be new option "Macro"<br /><br />NOTE: Please refer to the extension user guide for more details. User guide includes detailed explanation of how the extension.',
);
