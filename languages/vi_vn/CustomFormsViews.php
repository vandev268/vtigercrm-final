...
$languageStrings = array(
    'CustomFormsViews' => 'Custom Forms & Views',
    'LBL_MODULE' => 'Module',
    'LBL_NAME' => 'Name',
    'LBL_STATUS' => 'Status',
    'LBL_ACTIVE' => 'Active',
    ...
    'LBL_FIELDS_AND_LAYOUT_EDITOR1' => 'You have to go to',
    'LBL_FIELDS_AND_LAYOUT_EDITOR2' => 'to create fields and blocks for them to show up in the form.',
    'LBL_EDITOR_TEXT' => 'All the available blocks and fields are displayed below in the "Available Fields" block. In order to set up a view, you need to drag and drop the fields from "Available" block into the other blocks.',
    'LBL_PROFILES' => 'Profiles',

    /* For License page - Begin */
    'MODULE_LBL' => 'Custom Forms & Views',
